...
export class AnalyticsService {
  ...
  async getInventoryValuation() {
    ...
    // Group by warehouse
    const byWarehouse = inventory.reduce((acc: any, item) => {
   ...
   */
  async getStockTurnover(periodDays: number = 30) {
